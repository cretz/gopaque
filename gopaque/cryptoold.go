...
// func (k *KyberKeyPair) PublicKeyBytes() []byte {
...
// func (k *KyberKeyPair) PrivateKeyBytes() []byte {
// 	b, err := k.Private.MarshalBinary()
// 	if err != nil {
// 		panic(err)
// 	}
// 	return b
...
// func (k *KyberKeyPair) ToBytes() []byte { return k.PrivateKeyBytes() }

// func (k *KyberKeyPair) BytesSize() int { return k.Private.MarshalSize() }

// func (k *KyberKeyPair) Sign(b []byte) ([]byte, error) {
// 	return k.signer(b)
// }

// // Ed25519KeyPair implements KeyPair.
// type Ed25519KeyPair ed25519.PrivateKey
...
// // Sign implements KeyPair.Sign.
// func (e Ed25519KeyPair) Sign(b []byte) ([]byte, error) {
// 	return ed25519.Sign(ed25519.PrivateKey(e), b), nil
// }
